...
const APP_ROUTES: Routes = [
  ...
  { path: 'editardatoscliente/:idCliente', component: EditarClienteComponent, canActivate: [ AuthGuard ] },
  { path: 'editardatoscliente/:idEmpleado', component: EditarClienteComponent, canActivate: [ AuthGuard ] },
